...
function StatePlayerLoad_(I)
{
    ...
    // Load BetNominalSign with strict validation
    var BetNominalSignValue = DataGetIDefault("Roulette_Player_" + I + "_BetNominalSign", 1);
    // Ensure BetNominalSign is always 1 or -1, convert any invalid value to 1
    if (BetNominalSignValue === -1)
    {
        GamePlayer_[I].BetNominalSign = -1;
    }
    else
    {
        GamePlayer_[I].BetNominalSign = 1;
